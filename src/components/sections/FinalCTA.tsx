    ...
    return (
        <SectionWrapper id="contact" bg="dark">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <Link to="/le-projet">
                    <motion.div
                        className="group relative bg-gradient-to-br from-dark-card to-dark-bg border border-dark-border p-8 rounded-2xl overflow-hidden hover:border-primary-orange/50 transition-all cursor-pointer h-full"
                        whileHover={{ y: -10 }}
                    >
                        <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
                            <Smartphone className="w-24 h-24 text-primary-orange" />
                        </div>
                        <div className="relative z-10">
                            <div className="w-12 h-12 bg-primary-orange/20 rounded-xl flex items-center justify-center text-primary-orange mb-6 group-hover:scale-110 transition-transform">
                            ...
                            <div className="flex items-center text-primary-orange font-bold text-sm gap-2 mt-auto">
